...
const form = useForm({
  ...
  material_id: props.product.material_id != null ? String(props.product.material_id) : '',
  included: props.product.included ?? '',
  trips_required: props.product.trips_required ?? 1,
  payment_plan_id: props.product.payment_plan_id != null ? String(props.product.payment_plan_id) : DEFAULT_OPTION,
  quote_profile_id: props.product.quote_profile_id != null ? String(props.product.quote_profile_id) : DEFAULT_OPTION,
})
